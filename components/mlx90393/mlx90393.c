...
static esp_err_t mjd_byte_to_binary_string(uint8_t input_byte, char * output_string) {
...
esp_err_t mjd_mlx90393_cmd_read_measurement(const mjd_mlx90393_config_t* param_ptr_config, mjd_mlx90393_data_t* param_ptr_data) {
    ...
    case MJD_MLX90393_RES_XYZ_1:
        param_ptr_data->x = ((int16_t)(data_raw.x)*_sensitivity_xy[param_ptr_config->mlx_gain_sel][param_ptr_config->mlx_res_x] * (1 << (param_ptr_config->mlx_res_z)));
        break;
